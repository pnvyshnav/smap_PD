...
public:
    ...
    static constexpr NumType sensorRange = (const NumType) 0.6; // TODO was 1.5
    static constexpr NumType sensorNoiseStd = (const NumType) 0.0005; // TODO was 0.2 //(sensorRange / 10.); // TODO revert
